...
<head>
    ...
    <title>KUMPULAN GRAFIK - SMA NEGERI 7 YOGYAKARTA</title>
    <!--[if IE 8]>
    ...
    <section class="tz-introduce-univesity">
        ...
        <div class="tzWrap">
            ...
            <div class="container" id="fc">
                <div class="row">
                    <div class="tz-map-us">
                        <h3><a href="#">GRAFIK SMA 7 YOGYAKARTA</a></h3>
                        Grafik Calon Siswa Baru SMA 7 Yogyakarta terdiri dari pilihan kelas, jumlah pendaftar dan jumlah gender
                        <hr />
            ...
            <ul>
                ...
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                        ...
                        <hr />
                        <font color="white">Merupakan salah satu Sekolah Negeri tingkat SMA yang terletak di Jl. MT. Haryono No.47, Suryodiningratan, Kec. Mantrijeron, Kota Yogyakarta. tentu saja sekolah ini tidak akan kalah dengan sekolah-sekolah lainnya yang mempunyai akreditasi lebih baik.</font>
                    </div>
                </li>
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                        ...
                        <hr style="border-color: #334878" />
                        <font color="white">Jl. MT. Haryono No.47<br /> Suryodiningratan, Mantrijeron<br /> Kota Yogyakarta, Daerah Istimewa Yogyakarta 55141</font>
                    </div>
                </li>
            </ul>
        </div>
