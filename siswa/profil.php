                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="panel mb10">
                                            ...
                                            <div class="list-group fs14 fw600">
                                                <a class="list-group-item" href="#"><i class="fa fa-globe fa-fw text-primary"></i>&nbsp; sman7jogja.sch.id</a>
                                                <a class="list-group-item" href="#"><i class="fa fa-globe fa-fw text-primary"></i>&nbsp; smaven.id</a>
                                                <a class="list-group-item" href="#"><i class="fa fa-envelope-square fa-fw text-primary"></i>&nbsp; info@sman7jogja.sch.id</a>
                                                ...
                                                Jl. MT Haryono No.47, Yogyakarta, Daerah Istimewa Yogyakarta 55111</a>
                                            </div>
                                        </div>
