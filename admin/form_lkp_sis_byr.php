                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input class="form-control" id="disabledInput" type="text" name="jumlahnilai" value="<?php echo"$tp_dt_sis[29]";?>" placeholder="Inputkan Jumlah Nilai yang Tertera di IJAZAH Anda">
                                            </div>
                                        </div>
                                        <div class="form-group">
