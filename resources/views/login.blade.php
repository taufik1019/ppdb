...
<body>
            ...
            <ul>
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                        ...
                        <hr />
                        <font color="white">Sistem Informasi Penerimaan Siswa Baru SMA N 7 Yogyakarta Merupakan sistem informasi berbasis web yang dibangun menggunakan Bahasa Pemrograman PHP database MySQL. Sedangkan Front End dari Sistem Informasi ini menggunakan Framework Materializecss dan Bootstrap agar tampilan terlihat Menarik</font>
                    </div>
                </li>
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                        ...
                        <font color="white">Dengan adanya Sistem Informasi PPDB Online di SMA N 7 Yogyakarta diharapkan dapat membantu Calon siswa untuk melakukan Pendaftaran Tanpa harus datang ke sekolah untuk melakukan pendaftaran, menghemat biaya dan Waktu.</font>
                    </div>
                </li>
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                        ...
                        <hr />
                        <font color="white">Merupakan salah satu Sekolah Menengah Atas yang terletak di Suryodiningratan, Kec. Mantrijeron, Kota Yogyakarta, tentu saja sekolah ini tidak akan kalah dengan sekolah-sekolah lainnya yang mempunyai akreditasi lebih baik.</font>
                    </div>
                </li>
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
    ...
    <footer class="tz-footer">
        ...
        <div class="tz-footer-address-site">
            <address> Hak Cipta SMA N 7 Yogyakarta@ <?php date_default_timezone_set("Asia/Jakarta");
                                                                $thn = date("Y");
                                                                echo "$thn"; ?> | Program Pengembangan PPDB Oleh Kelompok 1 Kelas A2</address> | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
        </div>
    </footer>
    <!-- End Footer -->
