...
<head>
    ...
    <title>PPDB ONLINE - SMP MUHAMMADIYAH 4 YOGYAKARTA</title>
    <!--[if IE 8]>
            ...
            <div class="tz-slider-banner">
                <div class="tz-items">
                    ...
                    <div class="tz-banner-content">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=6285727434000" style="display: table; font-family: sans-serif; text-decoration: none; margin: 1em auto; color: #fff; font-size: 0.9em; padding: 1em 2em 1em 3.5em; border-radius: 2em; font-weight: bold; background: #25d366 url('https://tochat.be/click-to-chat-directory/css/whatsapp.svg') no-repeat 1.5em center; background-size: 1.6em;">Hubungi Panita/Admin
                        </a>
