...
<head>
    ...
    <title>FORM PENDAFTARAN PPDB ONLINE - SMA NEGRI 7 YOGYAKARTA</title>
    <!--[if IE 8]>
...
<body>
    ...
    <header class="tz-header tz-header-2">
        <div class="tz-sign-in">
            <div class="container">
                <p>SELAMAT DATANG DI APLIKASI PPDB ONLINE SMA NEGRI 7 YOGYAKARTA</p>
            </div>
        </div>
            ...
            <ul>
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                        ...
                        <hr />
                        <font color="white">Sistem Informasi Penerimaan Siswa Baru SMA NEGRI 7 YOGYAKARTA Merupakan sistem informasi berbasis web yang dibangun menggunakan Bahasa Pemrograman PHP database MySQL. Sedangkan Front End dari Sistem Informasi ini menggunakan Framework Materializecss dan Bootstrap agar tampilan terlihat Menarik</font>
                    </div>
                </li>
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                        ...
                        <font color="white">Dengan adanya Sistem Informasi PPDB Online di SMA NEGRI 7 YOGYAKARTA diharapkan dapat membantu Calon siswa untuk melakukan Pendaftaran Tanpa harus datang ke sekolah untuk melakukan pendaftaran, menghemat biaya dan Waktu.</font>
                    </div>
                </li>
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                ...
                <li>
                    <div class="tz-background-color-4" style="text-align: center">
                        ...
                        <hr style="border-color: #334878" />
                        <font color="white">Jl. MT. Haryono No. 47<br /> Suryodiningratan, Mantrijeron<br /> Kota Yogyakarta, Daerah Istimewa Yogyakarta 55111</font>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <footer class="tz-footer">
        ...
        <div class="tz-footer-address-site">
            <address> Hak Cipta SMA NEGRI 7 Yogyakarta @ <?php date_default_timezone_set("Asia/Jakarta");
                                                                $thn = date("Y");
